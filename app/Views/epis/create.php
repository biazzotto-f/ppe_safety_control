...
<form action="<?= $appUrl ?>/epis/store" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    <div class="image-preview-box mb-2">
                        <img src="https://placehold.co/180x180/e9ecef/6c757d?text=Foto+EPI" class="image-preview"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="id_categoria" name="id_categoria" required disabled>
                                <option value="" selected disabled>Selecione uma classificação primeiro</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="validade_ca" name="validade_ca">
                        </div>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="frequencia_troca" name="frequencia_troca"
                                min="0">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <small class="form-text text-muted">Deixe em branco se este EPI não necessitar de troca
                        programada.</small>
                    <hr class="my-4">
                    <div class="mb-3">
                            ...
                            <select class="form-select" id="fornecedor-select">
                                ...
                                <?php foreach ($fornecedores as $fornecedor): ?>
                                    <option value="<?= $fornecedor['id'] ?>"
                                        data-nome="<?= htmlspecialchars($fornecedor['nome_fornecedor']) ?>">
                                        <?= htmlspecialchars($fornecedor['nome_fornecedor']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <button class="btn btn-outline-primary" type="button"
                                id="add-fornecedor-btn">Adicionar</button>
                        </div>
                    </div>
