...
<form action="<?= $appUrl ?>/empresas/store" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    <div class="image-preview-box mb-2">
                        <img src="https://placehold.co/180x180/e9ecef/6c757d?text=Logo" class="image-preview"
                            alt="Preview" id="logoPreview">
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderUnidades() {
            ...
            if (unidades.length === 0) {
                unidadesList.innerHTML = '<li class="list-group-item text-center text-muted small">Nenhuma unidade cadastrada.</li>';
                return;
            }
            unidades.forEach((unidade, index) => {
                ...
                <div>
                    ...
                    <small class="text-muted">${unidade.logradouro}, ${unidade.numero}</small>
                </div>
                <div>
