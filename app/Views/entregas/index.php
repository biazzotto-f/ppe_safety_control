                    ...
                    <?php else: ?>
                        <?php foreach ($entregas as $entrega): ?>
                            <tr>
                                <td>
                                    <div class="user-avatar">
                                        <?php if ($entrega['foto_perfil']): ?>
                                            <img src="<?= $_ENV['APP_URL'] . '/' . $entrega['foto_perfil'] ?>" alt="Avatar" class="avatar-img">
                                        <?php else: ?>
                                ...
                                <td><?= $entrega['data_proxima_troca'] ? date('d/m/Y', strtotime($entrega['data_proxima_troca'])) : 'N/A' ?></td>
                                <td>
